...
| shemale | 人妖♂ | 有女性外观和胸部，但有男性生殖器，却没有阴道的女孩。一般情况下，内容里没有特别声明是人妖(shemale)的时候，应默认为扶她(futanari)，此标签常与扶她(futanari)标签混淆，有些标题甚至内容设定是扶她的作品未能明显展现阴道而被标上人妖(shemale)标签是不合理的，详情请参照作者グラナダの空 (十はやみ)的人妖作品。此标签或`futanari`是`dickgirl on male`，`male on dickgirl`，`dickgirl on dickgirl`的前置标签。那些有阴道的使用`futanari`表示。<br>同义词：伪娘(newhalf)、变性人(transsexual).<br>![图](# "https://exhentai.org/s/98c7d4b806/1621251-1") |  |
|  | === 性别 > 性别间关系 === |  |  |
