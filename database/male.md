...
| corset | 紧身胸衣 | 尤指旧时妇女束腰的紧身内衣。用于保持和塑造躯干的衣服，通常形成沙漏形状。需要`crossdressing`标签。 |  |
...
| pussyboys only | 纯扶他 | 在画廊中的所有性行为、迷恋或亲密的性交互之间都严格限定为`cuntboy`或`otokofutanari`。要求至少两个扶他进行交互。 |  |
